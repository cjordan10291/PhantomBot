...
$.lang.register('questsystem.finalbattle.start.success', 'The ruler of the land $1 speaks to all!  "$2, you are one of the bravest of my servants.  The time has come to vanquish The Dark Shadow of $3!  Let us prepare for battle!"');
$.lang.register('questsystem.finalbattle.success', 'You have joined the final battle with $1!');

$.lang.register('questsystem.evilgrows.usage', 'Usage: !evilgrows [$1].   This will strengthen the forces of evil. The Dark Shadow of $2 is currently as strong as an army worth $3 $4');
...
$.lang.register('questsystem.finalstories.1.chapter.1', 'The Dark Shadow of (greatEvil) awaits you, surrounded by an evil black aura of power! "I see you brought an army with you.  You will need it!" With a roar, the final fight commences!');
$.lang.register('questsystem.finalstories.1.chapter.2', 'During the ensuing battle, The Dark Shadow of (greatEvil) strikes down several of the brave companions who came to stop him!  Among the fallen are (caught)!');
$.lang.register('questsystem.finalstories.1.chapter.3','But even the greatest evil must pass.  The Dark Shadow of (greatEvil) is rent apart by (survivors).  They did not let their friends fall in vain!');
$.lang.register('questsystem.finalstories.1.chapter.4', 'After the final blow is struck,  (survivors) find the remaining treasure of The Dark Shadow of (greatEvil) and split it among themselves');